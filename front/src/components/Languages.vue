<template>
    <div class="grid grid-cols-2 gap-10 mx-auto lg:max-w-screen-lg lg:grid-cols-4">
      <div @mouseenter="show_text($event)" @mouseleave="hide_text($event)" class="flex flex-col items-center">
        <img ref="php" class="object-cover w-20 h-20 mb-2 rounded-full shadow" src="/assets/php.svg" alt="Person" />
      ...
      <div @mouseenter="show_text($event)" @mouseleave="hide_text($event)" class="flex flex-col items-center">
        <img ref="lua" class="object-cover w-20 h-20 mb-2 rounded-full shadow" src="/assets/lua.svg" alt="Logo de Lua" />
        <div class="flex flex-col items-center">
